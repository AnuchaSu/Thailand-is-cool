...
public class MenuAttractions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_attractions);
    ...
    public void changeOurTheme(){
        ...
        btnculture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(MenuAttractions.this, An.class);
                startActivity(a);
            }
        });
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(MenuAttractions.this, About.class);
                startActivity(a);
            }
        });
        btnfood.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(MenuAttractions.this, Ane.class);
                startActivity(a);
            }
        });
        btnlong.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(MenuAttractions.this, Aw.class);
                startActivity(a);
            }
        });
        btnbeautiful.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(MenuAttractions.this, As.class);
                startActivity(a);
            }
        });
    }
